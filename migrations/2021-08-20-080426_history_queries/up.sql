...
CREATE IF NOT EXISTS index data_entries_history_keys_block_uid_idx on data_entries_history_keys (block_uid);
...
CREATE IF NOT EXISTS index "data_entries_history_keys_stamp_idx" on data_entries_history_keys(address, key, block_timestamp desc, data_entry_uid desc);
CREATE IF NOT EXISTS index "data_entries_history_keys_height_idx" on data_entries_history_keys(address, key, height desc, data_entry_uid desc);
